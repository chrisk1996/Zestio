...
const enhancementTools = [
  {
    id: "auto-lighting" as const,
    icon: "light_mode",
    label: "Auto-Lighting",
    description: "Perfect exposure balance",
  },
  {
    id: "denoise" as const,
    icon: "grain",
  ...
  {
    id: "sky-replacement" as const,
    icon: "wb_twilight",
    label: "Sky Replacement",
    description: "Dramatic sky transforms",
  },
];
...
const furnitureCatalog = [
  {
    ...
    category: "Seating",
    image:
      "https://images.unsplash.com/photo-1555041469-a58646868261?w=400&q=80",
    price: "$2,499",
    style: "Contemporary",
  },
  {
  ...
  },
  {
    ...
    category: "Tables",
    image:
      "https://images.unsplash.com/photo-1533090481720-856c6e3c07a3?w=400&q=80",
    price: "$1,299",
    style: "Luxury",
  },
  {
  ...
  },
  {
    ...
    category: "Plants",
    image:
      "https://images.unsplash.com/photo-1459411552884-841db9b3cc2e?w=400&q=80",
    price: "$149",
    style: "Natural",
  },
  {
    ...
    category: "Storage",
    image:
      "https://images.unsplash.com/photo-1594620302200-9a2a3a79b4b3?w=400&q=80",
    price: "$799",
    style: "Mid-Century",
  },
  {
  ...
  },
  {
    ...
    category: "Dining",
    image:
      "https://images.unsplash.com/photo-1617806118233-18e1de247160?w=400&q=80",
    price: "$2,199",
    style: "Modern",
  },
  {
    ...
    category: "Office",
    image:
      "https://images.unsplash.com/photo-1518455029359-142d6c4e2892?w=400&q=80",
    price: "$1,499",
    style: "Professional",
  },
  {
    ...
    category: "Decor",
    image:
      "https://images.unsplash.com/photo-1541961017774-ee5879e76c3b?w=400&q=80",
    price: "$349",
    style: "Contemporary",
  },
  {
  ...
  },
  {
    ...
    category: "Lighting",
    image:
      "https://images.unsplash.com/photo-1524484485831-a92cd025f1d8?w=400&q=80",
    price: "$699",
    style: "Industrial",
  },
];
    ...
    <AppLayout title="Image Enhancer">
      <div className="flex h-[calc(100vh-5rem)]">
            ...
            {selectedRoom && (
              <div className="mt-4 space-y-2">
                ...
                <button
                  ...
                  disabled={isProcessing}
                  className="w-full mt-3 py-3 bg-purple-600 text-white rounded-xl font-bold text-sm hover:bg-purple-700 transition-colors disabled:opacity-50"
                >
          ...
          {!uploadedImage ? (
            ...
            <div className="relative w-full max-w-4xl">
              ...
              <img
                ...
                alt={enhancedImage ? "Enhanced" : "Uploaded"}
              ...
              {enhancedImage && (
                <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2">
                  <button
                    ...
                    className="px-4 py-2 bg-white/90 backdrop-blur rounded-lg text-sm font-semibold text-slate-700 shadow-lg hover:bg-white"
                  >
                    Show Original
                  </button>
                </div>
              ...
              {error && (
                <div className="absolute top-4 left-4 right-4 bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-xl text-sm">
                  {error}
                  <button
        ...
        <div className="w-96 shrink-0 border-l border-slate-200 bg-white overflow-y-auto">
          <div className="p-6">
            <h3 className="font-['Plus_Jakarta_Sans'] font-bold text-slate-900 text-lg mb-1">
              Furniture Catalog
            </h3>
            <p className="text-slate-500 text-xs mb-4">
          ...
          {/* Scene Layers */}
          <div className="p-6 border-t border-slate-200">
            <h3 className="font-['Plus_Jakarta_Sans'] font-bold text-slate-900 text-sm mb-4">
              Scene Objects
            </h3>
            <div className="space-y-2">
              ...
              {uploadedImage && (
                <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg border border-blue-200">
                  ...
                  <span className="material-symbols-outlined text-sm text-slate-400 cursor-pointer hover:text-slate-600">
                    more_vert
                  </span>
                </div>
              )}
          ...
          <div className="p-6 border-t border-slate-200">
            ...
            <p className="text-xs text-slate-500 text-center mt-2">
              AI suggests optimal furniture arrangements
            </p>
          </div>
        </div>
      </div>
